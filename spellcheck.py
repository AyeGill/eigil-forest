...
class ForesterParser:
    ...
    def __init__(self):
        ...
        self.custom_words = {
            'fibrations', 'optics', 'lenses', 'forester', 'markov', 'categorical',
            'bicategory', 'bicategories', 'monoidal', 'functorial', 'grothendieck',
            'eigil', 'rischel', 'hedges', 'myers', 'fritz', 'spivak', 'riley',
            ...
            'automorphism', 'automorphisms', 'covariant', 'contravariant',
            'stochastic', 'probabilistic', 'bayesian', 'reinforcement',
            'cybernetic', 'dynamical', 'parameterized', 'equilibrium',
            'minimax', 'von', 'neumann', 'morgenstern', 'nash', 'pareto',
            'arxiv', 'doi', 'isbn', 'issn', 'endofunctor', 'abelian', 'accessors', 'ackermann', 'actegorical',
            'actegories', 'adagrad', 'adjoints', 'agda', 'adjoint', 'amfr', 'amthematician', 'app', \ # Common academic identifiers
        }
